...
import utils
from models.nsf_HiFigan.models import MultiScaleDiscriminator
from models.nsf_univnet.nsfunivnet import nsfUnivNet
from modules.loss.nsf_univloss import nsf_univloss
from modules.loss.nsf_univloss_msd import nsf_univloss_msd
...
class nsf_univnet_task(GanBaseTask):
    ...
    def build_model(self):
        ...
        self.discriminator=nn.ModuleDict({'mrd':MultiScaleDiscriminator(), 'mpd':MultiPeriodDiscriminator(periods=self.config['model_args']['discriminator_periods'])})

    def build_losses_and_metrics(self):
        self.mix_loss=nsf_univloss_msd(self.config)
