...
class ddsp_univnet_task(GanBaseTask):
    ...
    def build_model(self):
        ...
        # h=AttrDict(cfg)
        self.generator=ddspUnivNet(self.config,use_weight_norm=self.config['model_args'].get('use_weight_norm',True))
    ...
    def build_losses_and_metrics(self):
        self.mix_loss=ddsp_univloss(self.config)
